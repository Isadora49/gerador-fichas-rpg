...
// 1. CARREGAMENTO COM CLONAGEM (Evita o erro de ArrayBuffer)
...
document.getElementById('pdf-canvas').addEventListener('click', (e) => {
    ...
    if (clicks.length === 4) {
        document.getElementById('status').innerText = "Pronto para gerar!";
...
// 3. DOWNLOAD E LÓGICA (C1 * C2) + C3 = RES (Versão Corrigida)
document.getElementById('btnDownload').addEventListener('click', async () => {
    try {
        ...
        // Lógica de Cálculo Interna do PDF
        const calculationJS = `
        ...
        // Injeta a ação de cálculo no campo de resultado
        ...
        // --- CORREÇÃO DA ORDEM DE CÁLCULO ---
        // Acessamos o dicionário do formulário de forma segura através do objeto 'form'
        ...
        a.href = url;
        a.download = "ficha_T20_automatizada.pdf";
